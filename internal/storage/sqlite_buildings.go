...
// SQLiteBuildingsInserter implements SQLiteBatchInserter for buildings
type SQLiteBuildingsInserter struct{}

// NewSQLiteBuildingsInserter creates a new SQLite buildings inserter
func NewSQLiteBuildingsInserter() *SQLiteBuildingsInserter {
	return &SQLiteBuildingsInserter{}
}

// TableName returns the table name for buildings
func (b *SQLiteBuildingsInserter) TableName() string {
	return "buildings"
}
...
func (b *SQLiteBuildingsInserter) BuildArgs(entity any, args []any, offset int) error {
