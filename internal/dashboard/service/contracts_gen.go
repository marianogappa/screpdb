...
type DashboardService interface {
	...
	PlayersSupplyDiscipline(ctx context.Context, request apigen.PlayersSupplyDisciplineRequestObject) (HandlerResult, error)
	...
	PlayerSupplyDiscipline(ctx context.Context, request apigen.PlayerSupplyDisciplineRequestObject) (HandlerResult, error)
