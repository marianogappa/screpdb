...
func HandlerWithOptions(si ServerInterface, options GorillaServerOptions) http.Handler {
	...
	r.HandleFunc(options.BaseURL+"/api/players/insights/first-unit-delay", wrapper.PlayersDelayHistogram).Methods(http.MethodGet)
...
func (t PlayersDelayHistogram200JSONResponse) MarshalJSON() ([]byte, error) {
	return GenericValue(t).MarshalJSON()
}

func (t *PlayersDelayHistogram200JSONResponse) UnmarshalJSON(b []byte) error {
	return (*GenericValue)(t).UnmarshalJSON(b)
}
...
func (t PlayerDelayInsight200JSONResponse) MarshalJSON() ([]byte, error) {
	return GenericValue(t).MarshalJSON()
}

func (t *PlayerDelayInsight200JSONResponse) UnmarshalJSON(b []byte) error {
	return (*GenericValue)(t).UnmarshalJSON(b)
}
