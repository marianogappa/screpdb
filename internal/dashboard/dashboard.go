...
func (d *Dashboard) setupRouter() *mux.Router {
	...
	r.HandleFunc("/api/workflow/players/{playerKey}/insights/unit-production-cadence", d.handlerWorkflowPlayerUnitCadence).Methods(http.MethodGet, http.MethodOptions)
