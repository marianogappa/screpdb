...
var workflowFeaturingFilters = []struct {
	...
	{Key: "bo_t_mech_noexpa", Label: "Mech (no expa)", Group: "bo", Race: "terran"},
	{Key: "bo_t_goliath_noexpa", Label: "Goliath (no expa)", Group: "bo", Race: "terran"},
	{Key: "bo_t_tankless_noexpa", Label: "Tankless Mech (no expa)", Group: "bo", Race: "terran"},
